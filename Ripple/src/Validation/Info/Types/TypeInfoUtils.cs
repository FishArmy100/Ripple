...
namespace Ripple.Validation.Info.Types
{
    static class TypeInfoUtils
    {
        ...
        public static Result<TypeInfo, List<ValidationError>> FromASTType(TypeName typeName, IReadOnlyList<string> primaryTypes, IReadOnlyList<string> activeLifetimes, SafetyContext safetyContext, bool requireLifetimes = false)
        {
